...
namespace MyTestCreator
{
	public class TestFileEncDec
	{
		...
		public static Gtk.FileFilter MyTestRawFileFilter
		{
			get
			{
				var filter = new Gtk.FileFilter ();
				filter.Name = "MyTest Raw files";
				filter.AddPattern ("*" + MyTestRaw);
				return filter;
			}
		}
		public static Gtk.FileFilter MyTestCompiledFileFilter
		{
			get
			{
				var filter = new Gtk.FileFilter ();
				filter.Name = "MyTest Compiled files";
				filter.AddPattern ("*" + MyTestCompiled);
				return filter;
			}
		}
